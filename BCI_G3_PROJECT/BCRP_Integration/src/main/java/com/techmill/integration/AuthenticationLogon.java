...
public class AuthenticationLogon {
	static Log mylog = new Log("LOGON");

	public ResponseAuth processRequest(String codigo, String password) throws IOException {
		InputStream input = AuthenticationLogon.class.getClassLoader()
		...
		prop.load(input);
		String Base_URL = prop.getProperty("AuthLogon_URL");
