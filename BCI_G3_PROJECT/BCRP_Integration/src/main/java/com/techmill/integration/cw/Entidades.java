...
public class Entidades {
	static Log log = new Log("CWEntidades");

	public RootEntidades processRequest(String sid) throws IOException {

		InputStream input = Entidades.class.getClassLoader().getResourceAsStream("config/bcrpConfig.properties"); // Read
		...
		prop.load(input);
		String Base_URL = prop.getProperty("Entidades_URL");
		...
		try {
			...
			RootEntidades root = gson.fromJson(element, RootEntidades.class);
