...
public class FacilidadesDisponibles {
	static Log log = new Log("CWFacilidadesDisponibles");

	public RootFacilidadesDisponibles processRequest(String sid) throws IOException {
		InputStream input = FacilidadesDisponibles.class.getClassLoader()
		...
		prop.load(input);
		String Base_URL = prop.getProperty("Facilidades_URL");
		...
		try {
			...
			RootFacilidadesDisponibles root = gson.fromJson(element, RootFacilidadesDisponibles.class);
