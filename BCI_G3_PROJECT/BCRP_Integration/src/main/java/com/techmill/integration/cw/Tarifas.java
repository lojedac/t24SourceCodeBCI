...
public class Tarifas {
	static Log log = new Log("CWTarifas");

	public RootTarifas processRequest(String sid) throws IOException {
		InputStream input = Tarifas.class.getClassLoader().getResourceAsStream("config/bcrpConfig.properties"); // Read
		...
		prop.load(input);
		String Base_URL = prop.getProperty("Tarifas_URL");
		...
		try {
			...
			RootTarifas root = gson.fromJson(element, RootTarifas.class);
