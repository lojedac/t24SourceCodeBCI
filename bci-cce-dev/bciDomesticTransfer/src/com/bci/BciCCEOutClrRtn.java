 ...
 *         -----------------------------------------------------------------------------------------------------------------
 */
public class BciCCEOutClrRtn extends ServiceLifecycle {
    ...
    public void processSingleThreaded(ServiceData serviceData) {
        ...
        try {
            ...
            if (today.equals(date)) {
                ...
                // String commisionAmountusd = "";
                // String sumAmountspen = "";
                // String fileAmountspen = "";
                // String fileAmountsusd = "";
                // String commisionAmountpen = "";
                ...
                List<String> recList = da.selectRecords("", "EB.BCI.CCE.MAPPING.FIELD.VALUES", "",
                        "WITH STATUS EQ TO_BE_RETURNED_IN_OFS OR STATUS EQ TO_BE_CONFIRMED_IN_PARTIAL AND DATE EQ "
                                + lastWorkingday + " AND TXN.TYPE EQ " + appcode);
                ...
                for (String recid : recList) {
                    ...
                    System.out.println("last date: " + lastdat);
                    System.out.println("last working date: " + lastWorkingday);

                    if (lastdat.equals(lastWorkingday)) {
                        ...
                        System.out.println("OE REC2: " + oeid);
                        ...
                        // String coin =
                        // payRec.getDebitaccountcurrency().getValue();
                        ...
                        try {
                            final EbBciCceGroundReturnRecord groudReturnRec = new EbBciCceGroundReturnRecord(
                        ...
                        additionalReturnRegistration = typeRegAdd.concat(addReg)
                                ...
                                .concat(StringUtils.leftPad(uniSeq, 7, "0"))
                                .concat(StringUtils.rightPad(freeAdd, 105, ""))
                        ...
                        /*
                         * try { sameOwner =
                         * payRec.getLocalRefField("L.SAME.OWNER").getValue();
                         * if (transferType.equals("220")) { if
                         * (sameOwner.equals("YES")) { docType =
                         * payRec.getLocalRefField("L.DRAWER.DOC.TYPE").getValue
                         * (); docNumber =
                         * payRec.getLocalRefField("L.DRAWER.DOC.NUMBER").
                         * getValue(); if (docType.equals("PA")) { docTypeValue
														   
                         * = "4"; } else if (docType.equals("CE")) {
														   
                         * docTypeValue = "5"; } else if (docType.equals("DN"))
                         * { docTypeValue = "2"; } else if
                         * (docType.equals("LM")) { docTypeValue = "3"; } else
														   
                         * if (docType.equals("RU")) { docTypeValue = "6"; }
														   
											
														   
									 
                         * else { docTypeValue = "1"; } String transferRef =
                         * docTypeValue.concat(docNumber); transferRef =
                         * StringUtils.rightPad(transferRef, 17, "0"); //
                         * StringBuilder strbline1 = new
                         * StringBuilder(individualRegistration); //
                         * StringBuilder linemod1 = strbline1.replace(152, 169,
                         * transferRef); // individualRegistration =
                         * linemod1.toString(); } else { String univoco =
                         * individualRegistration.substring(177, 184); long
                         * univocoLong = 0; try { univocoLong =
										 
                         * Long.parseLong(univoco); univoco =
                         * StringUtils.rightPad(String.valueOf(univocoLong), 24,
                         * "0"); } catch (Exception e) { } StringBuilder
									 
                         * strbline1 = new
                         * StringBuilder(individualRegistration); StringBuilder
                         * linemod1 = strbline1.replace(152, 176, univoco);
                        ...
                        // String credAcc =
                        // payRec.getCreditaccountnumber().getValue();
                        ...
                        // sumOfAmounts = String.format("%.02f",
                        // sumOfAmountslc);
                         ...
                         * new BigDecimal(sumOfAmountslc); String
                         * sumOfCommisions = ""; List<DebitchargecomponentClass>
                         * commList = payRec.getDebitchargecomponent();
                         * System.out.println("sumOfCommisions: " +
                         ...
                         * StringUtils.leftPad(entidadCode, 4,
                         * "0").concat(StringUtils.leftPad(officeCode, 4, "0"));
                         */
                        ...
                        String todayLH = today + "-" + "LOTHEADER";
                        String lotNumberLC = "";
                        try {
                            BciCceInterfaceParameterRecord archRec1 = new BciCceInterfaceParameterRecord(
                                    da.getRecord("EB.BCI.CCE.HEADER.COUNTER", todayLH));
                            lotNumberLC = archRec1.getFieldName(0).getFieldValue().getValue();
                ...
                if (!fileHeaderUSD.equals("")) {
                    ...
                    try {
                         ...
                         * sumlen).concat(sumAmountsusd.substring(sumlen + 1));
                ...
                if (!fileHeaderPEN.equals("")) {
                    ...
                    try {
                         ...
                         * sumlen).concat(sumAmountspen.substring(sumlen + 1));
                ...
                // System.out.println("Size " + lotEndSize + " is : " +
                // lotEndSize2);
