 ...
 *         -----------------------------------------------------------------------------------------------------------------
 */
public class BciCCEOutClrRtnTRI extends ServiceLifecycle {
            ...
            if (today.equals(date)) {
                ...
                for (String recid : recList) {
                    ...
                    if (lastdat.equals(lastWorkingday)) {
                         ...
                         * linemod1 = strbline1.replace(152, 169, transferRef);
                         * individualRegistration = linemod1.toString(); } else
